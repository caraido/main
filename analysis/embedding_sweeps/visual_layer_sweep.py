...
Usage (from main/):
    ...
    python -m analysis.embedding_sweeps.visual_layer_sweep --patients AA AZ VB --epochs 20 --model pls
...
def generate_html_report(df, stat_df, out_path):
    ...
    from analysis.helpers.visual_layer_sweep_report import generate_html_report as _gen
    _gen(df, stat_df, out_path)


def main():
    parser = argparse.ArgumentParser(
        prog='python -m analysis.embedding_sweeps.visual_layer_sweep',
    ...
    # ── Summary ──────────────────────────────────────────────────────────
    from analysis.helpers.visual_layer_sweep_report import print_console_summary
