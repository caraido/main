...
Usage:
    python -m main.analysis.cross_task_regression                    # all patients
    python -m main.analysis.cross_task_regression --patient AA       # one patient
    python -m main.analysis.cross_task_regression --patient AA --no-figs
