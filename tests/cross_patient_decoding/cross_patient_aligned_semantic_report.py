...
Usage (from main/):
    python -m tests.cross_patient_decoding.cross_patient_aligned_semantic_report
    python -m tests.cross_patient_decoding.cross_patient_aligned_semantic_report \\
...
def main():
    ...
    import tests.cross_patient_decoding.cross_patient_aligned_semantic_report as _self
