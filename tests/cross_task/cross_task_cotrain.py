...
Usage:
    ...
    python -m main.tests.cross_task.cross_task_cotrain --patient RB
    python -m main.tests.cross_task.cross_task_cotrain --models kernel_pls ridge krr
    python -m main.tests.cross_task.cross_task_cotrain --balance downsample --n-bootstrap 50
"""
...
OUT_ROOT = PROJECT_ROOT / "tests" / "results" / "cross_task_cotrain"
...
def _task_arrays(reg, chan_idx: np.ndarray, peak_bin: int,
    ...
    from tests.cross_task.cross_task_regression import (
