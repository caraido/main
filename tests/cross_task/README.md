...
```bash
python -m main.tests.cross_task.<script>
```
...
python -m main.tests.cross_task.cross_task_cotrain --patient AA --models kernel_pls ridge
...
python -m main.tests.cross_task.cross_task_channel_importance --analysis permutation
# plain-PLS VIP (linear, no significance test)
python -m main.tests.cross_task.cross_task_channel_importance --analysis pls
# or both
python -m main.tests.cross_task.cross_task_channel_importance --analysis both
# synthesis report
...
python -m main.tests.cross_task.cross_task_transfer_report
```
...
```bash
python -m main.tests.cross_task.cross_task_regression                 # all
python -m main.tests.cross_task.cross_task_regression --patient AA --no-figs
```
