...
Usage (from main/):
    python -m tests.pca_and_deflation_retrieval
    python -m tests.pca_and_deflation_retrieval --patients VB LH
    python -m tests.pca_and_deflation_retrieval --pca-components 5 10 20
    python -m tests.pca_and_deflation_retrieval --pls-components 10 --embeddings GloVe FastText
