...
Usage:
    python -m main.tests.open_vocab_retrieval.run
    python -m main.tests.open_vocab_retrieval.run --patient AA --n-perm 200
    python -m main.tests.open_vocab_retrieval.run --task auditory --headline-N 3000
    python -m main.tests.open_vocab_retrieval.run --concreteness-file data/concreteness.txt
"""
...
from tests.open_vocab_retrieval import gallery as gallery_mod
from tests.open_vocab_retrieval import predict_io, retrieval, metrics, relevance, stats, sweeps, figures
from tests.open_vocab_retrieval.predict_io import (
...
def run(patients: Sequence[str], run_folder: str, task: str,
    ...
    meta = {
        ...
        "command": "python -m main.tests.open_vocab_retrieval.run " + " ".join(sys.argv[1:]),
    }
