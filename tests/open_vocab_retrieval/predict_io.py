...
Reused project infrastructure:
  * ``tests.helpers.load_results_pkl``                    — unpickle results
...
def _peak_bin(run_folder: str, patient: str, embedding: str) -> int:
    from tests.cross_task.cross_task_regression import find_peak_bin
...
def make_predictions(patient: str, run_folder: str, task: str,
    ...
    from tests.cross_task.cross_task_regression import get_neural_at_bin, get_trial_metadata
    from tests.cross_task.cross_task_cotrain import make_model
