...
Extendability of the regression-and-retrieval decoder (picture naming; 12 participants).
...
signed-rank (see Results). Participants identified by display ID (NUEx###). **a**–**f** N=12.
