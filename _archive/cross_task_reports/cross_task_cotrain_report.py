...
#
# Usage:
#   python -m main.analysis.cross_task.cross_task_cotrain_report                 # latest run
#   python -m main.analysis.cross_task.cross_task_cotrain_report --in-dir <run> --model kernel_pls
