...
Usage (run from main/):
    python -m analysis.semantic_residual_regression
    python -m analysis.semantic_residual_regression --patients VB CP --epochs 20
    python -m analysis.semantic_residual_regression --sem-components 4 8 12
