...
Usage (run from main/):
    python -m analysis.cross_category_generalization
    python -m analysis.cross_category_generalization --patients VB CP AA --epochs 20
    python -m analysis.cross_category_generalization --resume
