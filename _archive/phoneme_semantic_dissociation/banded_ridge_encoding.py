...
Usage (run from main/):
    python -m analysis.banded_ridge_encoding
    python -m analysis.banded_ridge_encoding --patients VB WBH \\
        --phon-embs panphon --sem-embs GloVe FastText
    python -m analysis.banded_ridge_encoding --alpha-grid 0.01 0.1 1 10 100 1000
