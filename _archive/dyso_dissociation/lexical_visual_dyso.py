...
Usage (from main/):
    python -m analysis.lexical_visual_dyso
    python -m analysis.lexical_visual_dyso --patients VB LH --lex_embedding FastText --vis_embedding SimCLR
    python -m analysis.lexical_visual_dyso --patients VB LH --pca_dims 50
    python -m analysis.lexical_visual_dyso --align_method procrustes --align_target lex
...
def main():
    parser = argparse.ArgumentParser(
        prog='python -m analysis.lexical_visual_dyso',
